...
class Main(QWidget):
    ...
    def layouts(self):
        ...
        self.mainLayout.addLayout(
            self.leftLayout, 40
        )  # 40% din cat ocupa din layout!!!!!!
        self.mainLayout.addLayout(
            self.rightMainLayout, 60
        )  # 60% din cat ocupa din layout!!!!
        ########################adding widgets##################
    ...
    def singleClick(self):
        ...
        person = cur.execute(
            query, (id,)
        ).fetchone()  # WE NEED TO USE TUPLE , SINGLE ITEM TUPLE EX = (1,)
        img = QLabel()
            ...
            if mbox == QMessageBox.Yes:
                try:
                    ...
                    QMessageBox.information(
                        self, "Warning!!", "Person has not been deleted"
                    )
        else:
            QMessageBox.information(
                self, "Warning!!", "Please select a person to delete"
            )
